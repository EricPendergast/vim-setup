...
hi Boolean ctermfg=103 ctermbg=NONE cterm=NONE guifg=#9876aa guibg=NONE gui=bold
...
" Eric's Stuff
" Java highlighting
hi FunctionDeclaration ctermfg=040 ctermbg=NONE cterm=NONE guifg=#ffc66d guibg=NONE gui=NONE
"hi java ctermfg=040 ctermbg=NONE cterm=bold guifg=#b1c73d guibg=NONE gui=bold,italic
